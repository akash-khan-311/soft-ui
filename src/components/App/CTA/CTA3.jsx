...
const CTA3 = () => {
  return (
    <>
      <CodeBox
        stringCode={`<div className="2xl:mx-auto dark:bg-gray-900 2xl:container md:px-20 px-4 md:py-12 py-9">
  <div className="relative rounded-md">
    ...
    <div className="text-xl relative z-20 bg-gradient-to-r from-blue-700 to-transparent w-full h-full top-0 md:p-16 p-6 flex flex-col justify-between rounded-md ">
      <div>
        <h1 className=" text-3xl md:text-4xl lg:text-5xl font-bold md:leading-10 leading-9 text-white sm:w-auto w-64">Act Before Its Too Late!</h1>
        <p className="text-lg leading-6 text-white  lg:w-8/12 md:w-10/12  2xl:pr-12 mt-4">A good idiom for kids is "It's raining cats and dogs." Kids know what both cats and dogs are from an early age.</p>
      </div>
      ...
      >
        <div className="2xl:mx-auto dark:bg-gray-900 2xl:container md:px-20 px-4 md:py-12 py-9">
          <div className="relative rounded-md">
            ...
            <div className="text-xl relative z-20 bg-gradient-to-r from-blue-700 to-transparent w-full h-full  top-0 md:p-16 p-6 flex flex-col justify-between rounded-md ">
              <div>
                <h1 className=" text-3xl md:text-4xl lg:text-5xl font-bold md:leading-10 leading-9 text-white sm:w-auto w-64">
                  Act Before Its Too Late!
                </h1>
                <p className="text-lg leading-6 text-white  lg:w-8/12 md:w-10/12  2xl:pr-12 mt-4">
