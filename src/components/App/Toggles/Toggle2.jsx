...
const Toggle2 = () => {
  return (
    <>
      <CodeBox
        stringCode={`<div className="flex  mx-auto space-x-2 border-[3px] border-purple-400 rounded-xl select-none w-1/3 bg-white">
        ...
        <div className="flex  mx-auto space-x-2 border-[3px] border-purple-400 rounded-xl select-none w-1/3 bg-white">
          <label className="radio flex flex-grow items-center justify-center rounded-lg p-1 cursor-pointer">
            <input
              ...
              defaultChecked
            />
            <span className="tracking-widest peer-checked:bg-gradient-to-r peer-checked:from-[blueviolet] peer-checked:to-[violet] peer-checked:text-white text-black p-2 rounded-lg transition duration-150 ease-in-out">
              HTML
            </span>
          </label>
          <label className="radio flex flex-grow items-center justify-center rounded-lg p-1 cursor-pointer">
