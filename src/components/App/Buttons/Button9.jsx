...
const Button9 = () => {
  ...
  <svg height={24} width={24} className="rotate-[30deg] transition-transform duration-&lsqb;0.5s&rsqb; ease-[cubic-bezier(0.76,0,0.24,1)] mr-[3px] group-hover:translate-x-[5px]  group-hover:rotate-90" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <span className="transition-transform duration-&lsqb;0.5s&rsqb; ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:translate-x-[7px]">Launch</span>
</button> 
        ...
        <div className="flex items-center justify-evenly">
          <button className="group flex items-center cursor-pointer font-medium text-[17px] bg-[#ad5389] bg-[linear-gradient(to_right,#0f0c29,#302b63,#24243e)] text-[white] tracking-wider pl-[0.9em] pr-[1.3em] py-[0.8em] rounded-2xl border-[none]">
            <svg
              height={24}
              width={24}
              className="rotate-[30deg] transition-transform duration-&lsqb;0.5s&rsqb; ease-[cubic-bezier(0.76,0,0.24,1)] mr-[3px] group-hover:translate-x-[5px]  group-hover:rotate-90 "
              viewBox="0 0 24 24"
            ...
            <span className="transition-transform duration-&lsqb;0.5s&rsqb; ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:translate-x-[7px]">
              Launch
            </span>
          </button>
