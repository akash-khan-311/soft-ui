...
`}
      ...
      <div className="relative">
        {/* Drawer */}
        <div
          className={`fixed  w-full top-0 left-0 bottom-0 z-50 bg-blue-900 text-white p-6 h-44 md:h-52 lg:h-56 overflow-hidden transition-transform duration-500 transform ${
