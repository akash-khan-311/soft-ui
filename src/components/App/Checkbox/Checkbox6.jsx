...
const Checkbox6 = () => {
  return (
    <>
      <CodeBox
        stringCode={`<label className="flex items-center mb-3 space-x-3">
      ...
      >
        <div className="flex justify-center flex-wrap gap-10">
          <label className="flex items-center mb-3 space-x-3">
            ...
            />
            <span className="font-normal  text-white">Blue</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Pink</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Green</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Orange</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Purple</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Black</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Indigo</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Red</span>
          </label>
          <label className="flex items-center mb-3 space-x-3">
            <input
              type="checkbox"
            ...
            />
            <span className="font-normal  text-white">Gray</span>
          </label>
        </div>
      </CodeBox>
    </>
