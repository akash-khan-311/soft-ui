...
`}
      >
        <div className="flex justify-center gap-5 flex-wrap">
          {/* Shopping Icon Badge */}
          <button
            className="py-4 px-1 relative border-2 border-transparent text-gray-200 rounded-full hover:text-gray-400 focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out"
            aria-label="Cart"
          >
            <svg
              className="h-6 w-6"
