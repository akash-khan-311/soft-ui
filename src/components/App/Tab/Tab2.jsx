...
const tabData = [
  {
    label: "Tab-1",
    description:
      "Tab-1 description --Welcome to Soft UI, where innovation takes flight. Explore our meticulously crafted components designed to elevate your projects. Redefine UI design with Soft UI, one component at a time. ",
  },
  {
    label: "Tab-2",
    description:
      "Tab-2 description --Welcome to Soft UI, where innovation takes flight. Explore our meticulously crafted components designed to elevate your projects. Redefine UI design with Soft UI, one component at a time. ",
  },
  {
    label: "Tab-3",
    description:
      "Tab-3 description --Welcome to Soft UI, where innovation takes flight. Explore our meticulously crafted components designed to elevate your projects. Redefine UI design with Soft UI, one component at a time. ",
  },
  {
    label: "Tab-4",
    description:
      "Tab-4 description --Welcome to Soft UI, where innovation takes flight. Explore our meticulously crafted components designed to elevate your projects. Redefine UI design with Soft UI, one component at a time. ",
  },
  {
    label: "Tab-5",
    description:
      "Tab-5 description --Welcome to Soft UI, where innovation takes flight. Explore our meticulously crafted components designed to elevate your projects. Redefine UI design with Soft UI, one component at a time. ",
  },
];
          ...
          {tabData.map((tab, i) => (
            <li
              ...
              className={`cursor-pointer text-xl px-4 py-2 transition-all duration-300 ${
                i === activeTab ? "bg-white  text-black" : "text-white"
              }`}
            >
              {tab.label}
            </li>
