...
const Card13 = () => {
  return (
    <>
      <CodeBox
        text={"Product Grid Card"}
        stringCode={`<div className="p-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
  ...
  <div className="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg group">
    ...
    <div className="relative text-white px-6 pb-6 mt-6">
      ...
      >
        <div className="p-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg group">
            <svg
              className="absolute bottom-0 left-0 mb-8 scale-150 group-hover:scale-[1.65] transition-transform"
              viewBox="0 0 375 283"
