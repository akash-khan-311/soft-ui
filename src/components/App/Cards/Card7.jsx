  ...
  return (
    <>
      <CodeBox
        ...
        stringCode={`<div className="w-3/5 mx-auto">
        ...
        <div className="w-3/5 mx-auto">
          <div className="flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:flex-row">
            <Image
              width={400}
              height={200}
              className="md:w-1/3 rounded-t-lg object-cover md:h-auto md:!rounded-none md:!rounded-l-lg"
              src="https://cdn.vox-cdn.com/thumbor/ByNALa-QJ5kMX38tGQNt7o13S00=/0x0:2040x1360/768x512/filters:focal(1020x680:1021x681)/cdn.vox-cdn.com/uploads/chorus_asset/file/24677165/236652_HP_Spectre_x360_14_AKrales_0138.jpg"
              alt="Card Image"
            />
            <div className="flex flex-1 flex-col justify-start p-6">
