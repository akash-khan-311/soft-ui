...
const Footer11 = () => {
  return (
    <>
      <CodeBox
        stringCode={`<footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <a className="flex items-center justify-start" href="/"> <img src="/logo.png" className="mr-5 h-6 sm:h-9" alt="logo" /><span className="self-center text-2xl font-semibold whitespace-nowrap  logo-text"> Soft UI </span> </a>
      ...
      >
        ...
        <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
          <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              <div>
                <a className="flex items-center justify-start" href="/">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap  logo-text">
                    Soft UI
                  </span>
                </a>
                <p className="max-w-xs mt-4 text-sm text-gray-600">
            ...
            <p className="mt-8 text-xs text-gray-800">© 2024 Soft UI</p>
          </div>
        </footer>
      </CodeBox>
    </>
