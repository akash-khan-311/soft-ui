...
const Progress4 = () => {
  return (
    <>
      <CodeBox
        text={"Color Progress"}
        stringCode={`<div className="mb-7">
    <div className="flex justify-between py-1">
      <span className="text-base font-semibold text-white">Web Design</span>
      <span className="text-base font-semibold pr-5 text-white">80%</span>
    </div>
...
<div className="mb-7">
  <div className="flex justify-between py-1">
    <span className="text-base font-semibold text-white">Mobile App </span>
    <span className="text-base font-semibold pr-5 text-white">95%</span>
  </div>
  <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
    <path className="rc-progress-line-trail" d="M 0.5,0.5
   L 99.5,0.5" strokeLinecap="round" stroke="#D9D9D9" strokeWidth={1} fillOpacity={0} />
...
<div className="mb-7">
  <div className="flex justify-between py-1">
    <span className="text-base font-semibold text-white">Illustrator</span>
    <span className="text-base font-semibold pr-5 text-white">65%</span>
  </div>
  <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
    <path className="rc-progress-line-trail" d="M 0.5,0.5
   L 99.5,0.5" strokeLinecap="round" stroke="#D9D9D9" strokeWidth={1} fillOpacity={0} />
...
<div className="mb-7">
  <div className="flex justify-between py-1">
    <span className="text-base font-semibold text-white">Photoshope</span>
    <span className="text-base font-semibold pr-5 text-white">75%</span>
  </div>
  <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
    <path className="rc-progress-line-trail" d="M 0.5,0.5
   L 99.5,0.5" strokeLinecap="round" stroke="#D9D9D9" strokeWidth={1} fillOpacity={0} />
        ...
        <div className="max-w-xl mx-auto p-4">
          <div className="mb-7">
            <div className="flex justify-between py-1">
              ...
              <span className="text-base font-semibold pr-5 text-white">
                80%
              </span>
            </div>
            <svg
