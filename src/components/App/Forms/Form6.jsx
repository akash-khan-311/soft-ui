...
const Form6 = () => {
  return (
    <>
      <CodeBox
        text={"Login Form"}
        stringCode={`  <div className="flex h-full items-center justify-center">
              ...
              <div className="left-0 right-0 inline-block border-gray-200 px-2 py-2.5 sm:px-4">
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      type="submit"
                      className="border transition-colors focus:ring-2 p-0.5 disabled:cursor-not-allowed border-transparent bg-blue-600 hover:bg-blue-700 active:bg-sky-800 text-white disabled:bg-gray-300 disabled:text-gray-700 rounded-lg "
                    >
                      <span className="flex items-center justify-center gap-1 font-medium py-1 px-2.5 text-base false">
                        Login
                      </span>
