...
const Form14 = () => {
  return (
    <CodeBox
      stringCode={`<div className="flex justify-center items-center  max-w-md mx-auto">
   <div className="popup bg-white shadow-lg rounded-lg p-6">
    <form className="form space-y-4">
    <div className="icon flex justify-center items-center w-14 h-14 bg-blue-100 rounded-md">
               {/* SVG code */}
        ...
        <div className="note">
        <label className="title text-lg font-semibold text-gray-700">Subscribe for updates</label><br />
        <span className="subtitle text-sm font-semibold text-gray-600">Subscribe to this weekly news letter so you
                 don’t miss out on the new hot tech topics.</span>
        </div>
        <input placeholder="Enter your e-mail" title="Enter your e-mail" name="email" type="email"
        className="input_field border border-blue-100 rounded-md px-3 py-2 w-full focus:outline-none focus:border-transparent focus:ring-2 focus:ring-blue-500" />
        <button type="submit"
        className="submit flex justify-center items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-md transition duration-300 ease-in-out hover:from-blue-600 hover:to-blue-800">
        <span>Submit</span>
        </button>
        </form>
        </div>
      ...
      <div className="flex justify-center items-center  max-w-md mx-auto">
        <div className="popup bg-white shadow-lg rounded-lg p-6">
          <form className="form space-y-4">
            ...
            <div className="note">
              <label className="title text-lg font-semibold text-gray-700">
                Subscribe for updates
              </label>
              <br />
              <span className="subtitle text-sm font-semibold text-gray-600">
