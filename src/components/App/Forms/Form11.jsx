...
const Form11 = () => {
  return (
    <div>
      <CodeBox
        stringCode={`<div className="container mx-auto px-4 py-8 bg-white">
            ...
            <div className="flex flex-col md:flex-row border-b border-gray-400 py-4">
              <div className="flex-shrink-0 w-32 h-32">
                <Image
                  width={600}
                  height={400}
                  src="https://ds.rokomari.store/rokomari110/ProductNew20190903/260X372/Hyater_Din_Furole-Arif_Azad-6a7f5-372019.jpg"
                  alt="Product image"
