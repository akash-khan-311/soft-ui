...
const Form15 = () => {
  return (
    <CodeBox
      stringCode={` <div className="card w-64 bg-white border border-gray-300 rounded-md shadow-md mx-auto">
    ...
    >
      <div className="card w-64 bg-white border border-gray-300 rounded-md shadow-md mx-auto">
        ...
        <div className="chat-input flex border-t border-gray-300">
          <input
            type="text"
            className="message-input flex-1 border-none outline-none py-2 px-4 text-sm"
            placeholder="Type your message here"
          />
