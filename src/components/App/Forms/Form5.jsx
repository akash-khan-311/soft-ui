...
const Form5 = () => {
  return (
    <>
      <CodeBox
        text={"Signup Form"}
        stringCode={`<div className="flex items-center justify-center px-4 sm:px-6 lg:px-8">
    ...
    <div className="bg-white shadow-md rounded-md p-6">
      ...
      <form className="space-y-6" method="POST">
        ...
        <div>
          <button
            type="submit"
            className="flex w-full justify-center rounded-md border border-transparent  bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2"
          >
            Register Account
          </button>
        </div>
