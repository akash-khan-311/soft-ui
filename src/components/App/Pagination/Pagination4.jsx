...
const Pagination4 = () => {
  return (
    <div>
      <CodeBox
        stringCode={`<div className="container mx-auto px-4">
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            {/* Previous Page Button */}
            <a
              className="flex w-10 h-10 mr-1 justify-center items-center rounded-full border border-gray-600 bg-orange-800 text-white  hover:border-gray-200"
              href="#!"
              title="Previous Page"
            >
              <span className="sr-only">Previous Page</span>
            ...
            {/* Page Buttons (1 to 5) */}
            <a
              className="hidden md:flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-gray-600    text-white  hover:border-gray-200"
              href="#!"
              title="Page 1"
            >
              1
            ...
            <a
              className="hidden md:flex w-10 h-10 mx-1 justify-center items-center rounded-full border  border-white  text-white pointer-events-none"
              href="#!"
              aria-current="page"
              title="Page 3"
            >
            ...
            {/* Next Page Button */}
            <a
              className="flex w-10 h-10 ml-1 justify-center items-center rounded-full border border-gray-600 bg-orange-800 text-white  hover:border-gray-200"
              href="#!"
              title="Next Page"
            >
              <span className="sr-only">Next Page</span>
