...
<form className="flex ">
  ...
  <button type="submit" className="px-4 py-2 text-sm text-white font-bold uppercase bg-blue-600 rounded-r-lg  active:bg-blue-800">
    Subscribe
  </button>
</form>      
      ...
      >
        <div className="flex justify-evenly flex-wrap gap-5">
          ...
          <form className="flex flex-wrap justify-center  ">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-sm text-white font-bold uppercase bg-blue-600 rounded-r-lg  rounded-lg sm:rounded-l-none  active:bg-blue-800"
            >
              Subscribe
            </button>
          </form>
