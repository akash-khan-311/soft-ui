...
const Table1 = () => {
  return (
    <div>
      <CodeBox
        stringCode={` <div className="shadow-lg rounded-lg  mx-4 md:mx-10 overflow-x-auto">
      ...
      >
        <div className="shadow-lg rounded-lg  mx-4 md:mx-10 overflow-x-auto">
          <table className="w-full ">
            <thead>
              <tr className="bg-gray-100">
                <th className="lg:w-1/4 w-full py-4 px-6 text-left text-gray-600 font-bold uppercase">
                  Name
                </th>
                <th className="lg:w-1/4 w-full py-4 px-6 text-left text-gray-600 font-bold uppercase">
                  Email
