        ...
        <div className="flex justify-center">
          <div className=" relative inline-flex mb-40 ">
            <button
              ...
              type="button"
              className="relative inline-flex items-center px-8 py-2 rounded border border-transparent bg-blue-600  text-white font-medium transition-all duration-200 hover:bg-blue-800 active:translate-y-[2px]"
            >
              Actions
              <svg
            ...
            <div
              className={`absolute overflow-hidden top-10 transition-[opacity,margin] duration-300 ease-in-out ${
                isOpen ? "opacity-100" : "opacity-0 invisible"
              }   min-w-60 backdrop-blur-md bg-white/10 shadow-md rounded-lg p-2 mt-2 divide-y divide-gray-200 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700`}
            >
              <div className="py-2 first:pt-0 last:pb-0">
                <a
                  className={`flex ${
                ...
                <a
                  className={`flex ${
                    isOpen
                      ? "translate-x-0 delay-150 duration-200 transition-all ease-in-out"
                      : "-translate-x-full opacity-0"
                  } items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-100 hover:text-gray-800 hover:bg-gray-300 focus:outline-none focus:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:bg-gray-700`}
                  href="#"
                >
